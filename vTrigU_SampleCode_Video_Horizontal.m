...
mySettings.freqRange.numFreqPoints = 100;
...
%%
Nx = 80; Ny = 80; Nz = 80;
xgrid = linspace(-0.2, 0.4, Nx);%-0.3:0.1:0.3;
zgrid = linspace(-0.2, 0.4, Nz);
ygrid = [0.15,0.15];
...
save('radar_scan_dataXZ1.mat', 'recs', 'xgrid','ygrid','zgrid','freq','TxRxPairs');
threeDPrinter("home");
threeDPrinter("close");
